...
import { email, githubUrl, linkedInUrl, displayName, bannerDescription, bannerDescription2, resumePdfTitle } from '../data';
        ...
        <div className="banner">
            ...
            <div className="container-fluid banner-content">
                <div className="name-wrapper">
                    ...
                    <p className={`section-description fade-right-sm ${showTitle ? "show" : ""}`}>{bannerDescription2}</p>
                </div>

                <div className={`delay-sm ${showButtons ? "show" : ""}`}>
                    <a className="btn btn-dark btn-main d-none d-sm-block" href={"https://drive.google.com/file/d/1SkhMNHsmNpipZDPiFEqGcz8eju5l-Ito/view?usp=sharing"} download>履歴書/Resume</a>
